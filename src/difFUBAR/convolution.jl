...
"""
function apply_smoothing(layout::ProbabilityVectorReshapingScheme, ambient_parameters::AbstractVector{<:Real}, kernel_parameters::AbstractVector{<:Real})
    ambient_parameter_array = reshape_probability_vector(layout, ambient_parameters)
    ...
    return unreshape_probability_vector(layout, smoothed_parameter_array)
end
